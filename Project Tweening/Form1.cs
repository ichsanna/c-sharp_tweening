...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            DoubleBuffered = true;
            label_canvas.Text = "Gambar: " + current;
            ...
            new PointF(178, 400 - 120),
            new PointF(191, 400 - 120),
            new PointF(193, 400 - 120),
            new PointF(199, 400 - 120),
            new PointF(200, 400 - 120),
            new PointF(201, 400 - 120),
            new PointF(202, 400 - 120),
            new PointF(203, 400 - 120),
            new PointF(204, 400 - 120),
            new PointF(205, 400 - 120),
            new PointF(207, 400 - 120),
            new PointF(208, 400 - 120),
            new PointF(209, 400 - 120),
            new PointF(210, 400 - 120),
            new PointF(211, 400 - 120),
            new PointF(212, 400 - 120),
            new PointF(213, 400 - 120),
            new PointF(214, 400 - 120),
            new PointF(215, 400 - 120),
            new PointF(216, 400 - 120),
            new PointF(219, 400 - 120),
            new PointF(232, 400 - 120),
            new PointF(241, 400 - 120),
            new PointF(251, 400 - 120),
            new PointF(263, 400 - 120),
            new PointF(271, 400 - 120),
            new PointF(280, 400 - 120),
            new PointF(288, 400 - 120),
            new PointF(298, 400 - 120),
            new PointF(308, 400 - 120),
            new PointF(324, 400 - 120),
            new PointF(331, 400 - 120),
            new PointF(341, 400 - 120),
            new PointF(349, 400 - 120),
            new PointF(357, 400 - 120),
            new PointF(366, 400 - 120),
            new PointF(374, 400 - 121),
            new PointF(381, 400 - 121),
            new PointF(390, 400 - 122),
            new PointF(397, 400 - 123),
            new PointF(405, 400 - 123),
            new PointF(411, 400 - 125),
        ...
        {
            frame = Convert.ToInt32(textBox_frame.Text);
